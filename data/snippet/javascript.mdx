---
title: javascript
description: Common JavaScript Technical Questions
...
[Reference javascript function hoisting](https://developer.mozilla.org/en-US/docs/Glossary/Hoisting)
...
[Reference setTimeout reasons for delays longer than specified](https://developer.mozilla.org/en-US/docs/Web/API/setTimeout#reasons_for_delays_longer_than_specified)
...
## Q132. How can you add a data item named "animal" with a value of "sloth" to the local storage of the current domain using JavaScript?
...
Which option correctly demonstrates the use of `localStorage.setItem` to achieve this?
